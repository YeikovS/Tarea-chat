 ...
 * @author Yeikov
 */
public class Usuario1SocketGUI extends javax.swing.JFrame {

    /**
     * Creates new form ChatClientGUI
     */
    public Usuario1SocketGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Usuario1SocketGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Usuario1SocketGUI().setVisible(true);
            }
        });
    }
