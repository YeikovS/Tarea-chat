 ...
 * @author Yeikov
 */
public class ServeerSocketGUI extends javax.swing.JFrame {

    /**
     * Creates new form ChatServerGUI
     */
    public ServeerSocketGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServeerSocketGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServeerSocketGUI().setVisible(true);
            }
        });
    }
